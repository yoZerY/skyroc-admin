...
export async function backEndFail(
  response: AxiosResponse<Api.Service.Response, any>,
  instance: AxiosInstance,
  request: RequestInstance<Api.Service.Response, RequestInstanceState>
) {
...
export function handleError(
  error: AxiosError<Api.Service.Response<unknown>, any>,
  request: RequestInstance<Api.Service.Response, RequestInstanceState>
) {
